...
<template>
  <div
    ...
    <div class="flex-1">
      ...
      <!-- ID -->
      <p class="text-sm font-normal text-gray-500 mb-2 leading-none tracking-wide">Nr. {{
        pokemon.id.toString().padStart(3,
          '0') }}</p>
    </div>

    <!-- Pokemon Image -->
    <div class="flex-shrink-0">
      <img :src="pokemon.sprites.front_default" :alt="pokemon.name" class="w-14 h-14 object-contain" loading="lazy" />
    </div>
  </div>
</template>
